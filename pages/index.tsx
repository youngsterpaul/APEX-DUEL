        ...
        <div style={cardStyle}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxHeight: 390, overflowY: 'auto' }}>
            {loading ? (
              ...
              challenges.slice((lobbiesPage - 1) * LOBBIES_PAGE_SIZE, lobbiesPage * LOBBIES_PAGE_SIZE).map((c) => (
          ...
          {!loading && challenges.length > 0 && (
            <Pagination page={lobbiesPage} totalPages={Math.max(1, Math.ceil(challenges.length / LOBBIES_PAGE_SIZE))} onChange={setLobbiesPage} />
          )}
        </div>
