                ...
                >
                  <div>
                    <h4 style={{ margin: '0 0 4px 0', fontSize: 16 }}>
                      {d.game}
                      {d.join_mode === 'approval' && (
                        <span style={{ marginLeft: 8, fontSize: 10, fontWeight: 800, color: 'var(--gold)', border: '1px solid var(--gold)', borderRadius: 12, padding: '2px 8px', textTransform: 'uppercase', verticalAlign: 'middle' }}>
                          Approval Required
                        </span>
                      )}
                    </h4>
